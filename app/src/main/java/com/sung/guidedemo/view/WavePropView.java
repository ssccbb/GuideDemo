...
public class WavePropView extends View {
    ...
    public WavePropView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WavePropView(Context context) {
        this(context, null, 0);
    }

    public WavePropView(Context context, AttributeSet attrs, int defStyle) {
